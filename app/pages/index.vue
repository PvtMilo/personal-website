        ...
        <ul class="grid grid-cols-3 sm:grid-cols-7 text-center lg:gap-4">
          <li class="flex flex-col sm:col-start-3 items-center gap-2 border-2">
            ...
            >
              ...
              >
                <path
                  d="M22.672 10.504 13.496 1.328a1.12 1.12 0 0 0-1.584 0l-1.904 1.904 2.416 2.416a1.33 1.33 0 0 1 1.68 1.696l2.328 2.328a1.33 1.33 0 1 1-.8.752l-2.176-2.176v5.728a1.33 1.33 0 1 1-1.096 0V8.2a1.33 1.33 0 0 1-.72-1.744L9.28 4.096 1.328 12.048a1.12 1.12 0 0 0 0 1.584l9.176 9.176a1.12 1.12 0 0 0 1.584 0l10.584-10.584a1.12 1.12 0 0 0 0-1.72Z"
                  fill="#F05032"
                />
              </svg>
            </div>
          ...
          <li class="flex flex-col items-center gap-2 border-2">
            ...
            >
              ...
              >
                <path
                  fill="#fff"
                  d="M12 .5C5.648.5.5 5.648.5 12c0 5.084 3.292 9.4 7.86 10.922.575.106.785-.25.785-.556 0-.274-.01-1-.016-1.962-3.197.695-3.872-1.54-3.872-1.54-.523-1.328-1.278-1.682-1.278-1.682-1.044-.714.08-.7.08-.7 1.154.08 1.76 1.184 1.76 1.184 1.026 1.758 2.692 1.25 3.348.956.104-.744.402-1.25.73-1.538-2.552-.29-5.236-1.276-5.236-5.682 0-1.256.448-2.284 1.182-3.09-.118-.29-.512-1.458.112-3.04 0 0 .964-.308 3.158 1.18A10.97 10.97 0 0 1 12 6.032c.974.004 1.956.132 2.874.388 2.192-1.488 3.154-1.18 3.154-1.18.626 1.582.232 2.75.114 3.04.736.806 1.18 1.834 1.18 3.09 0 4.418-2.688 5.388-5.25 5.672.414.356.782 1.058.782 2.132 0 1.54-.014 2.782-.014 3.162 0 .31.206.668.792.554C20.21 21.396 23.5 17.082 23.5 12 23.5 5.648 18.352.5 12 .5Z"
                />
              </svg>
            </div>
